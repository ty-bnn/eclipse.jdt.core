...
public class Type2 extends Expression {
	/**
	 * @since 3.39
	 */
	public static final ChildListPropertyDescriptor ELEMENTS_PROPERTY =
			new ChildListPropertyDescriptor(Type2.class, "elements", ASTNode.class, NO_CYCLE_RISK); //$NON-NLS-1$

	private static final List PROPERTY_DESCRIPTORS;

	static {
		List properyList = new ArrayList(5);
		createPropertyList(Type2.class, properyList);
