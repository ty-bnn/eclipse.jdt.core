...
public class Name2 extends Name {
	...
	public static final ChildListPropertyDescriptor ELEMENTS_PROPERTY =
			new ChildListPropertyDescriptor(Name2.class, "elements", SimpleName.class, NO_CYCLE_RISK); //$NON-NLS-1$

	private static final List PROPERTY_DESCRIPTORS;

	static {
		List properyList = new ArrayList(5);
		createPropertyList(Name2.class, properyList);
